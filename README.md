...
- [markedjs/marked-mangle](https://github.com/markedjs/marked-mangle) -  (today)
- [mrsimonemms/mrsimonemms.github.io](https://github.com/mrsimonemms/mrsimonemms.github.io) - My website (today)
- [mrsimonemms/simonmakesstuff](https://github.com/mrsimonemms/simonmakesstuff) - My blog about the things I make (today)
...
- [loft-sh/devpod](https://github.com/loft-sh/devpod) ([v0.1.11-beta.0](https://github.com/loft-sh/devpod/releases/tag/v0.1.11-beta.0),
  today) - Codespaces but open-source, client-only and unopinionated: Works with any IDE and lets you use any cloud, kubernetes or just on localhost docker.
